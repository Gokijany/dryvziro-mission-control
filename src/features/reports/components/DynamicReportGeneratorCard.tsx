...
export function DynamicReportGeneratorCard() {
  ...
  return (
    <div className="rounded-xl border border-border/80 bg-card p-6 shadow-sm flex flex-col justify-between h-full">
      <div>
        <div className="mb-6">
          <span className="text-[10px] font-bold tracking-widest text-primary">DYNAMIC GENERATOR</span>
          <h2 className="text-xl font-bold text-foreground mt-1">Create Custom Intelligence Report</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          {/* Timeframe Range */}
          <div className="space-y-2">
            <label className="text-[10px] font-bold tracking-wider text-muted-foreground uppercase">TIMEFRAME RANGE</label>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center justify-between rounded-lg border border-border/80 bg-background px-3 py-2 text-xs text-muted-foreground shadow-sm">
                <span>mm/dd/yy</span>
          ...
          {/* Target Modules */}
          <div className="space-y-2">
            <label className="text-[10px] font-bold tracking-wider text-muted-foreground uppercase">TARGET MODULES</label>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-border/40 gap-4">
        ...
        <button 
          type="button"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-2.5 text-xs font-bold text-primary-foreground hover:opacity-95 transition-opacity shadow-sm"
        >
