  ...
  return (
    <div className="rounded-xl border border-border/80 bg-card p-6 shadow-sm flex flex-col justify-between h-full">
      <div>
        ...
        <p className="text-xs text-foreground mt-1 mb-4 leading-relaxed">
      ...
      <div className="space-y-3">
        {exports.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="group flex items-center justify-between rounded-lg border border-border/80 bg-background p-3 shadow-sm hover:border-primary/50 transition-colors"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[9px] font-semibold tracking-wider text-foreground">
                    {item.subtitle}
                  </span>
                </div>
              </div>
              <button
                type="button"
                className="rounded-md p-2 text-foreground hover:bg-primary/10 hover:text-primary transition-colors"
