      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-muted-foreground">Target: {data.target}</span>
          </div>
        </div>
        ...
        <div className="mt-3 flex items-baseline gap-3">
          ...
          <span className="text-sm font-medium text-muted-foreground">MT CO2e</span>
        </div>
      </div>

      <div className="mt-8">
        <div className="relative h-32 w-full">
          <svg className="absolute inset-0 h-full w-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 700 120">
            <defs>
              <linearGradient id="carbonGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#B4E920" stopOpacity="0.4" />
                <stop offset="100%" stopColor="#B4E920" stopOpacity="0.0" />
              </linearGradient>
            </defs>
            <path
